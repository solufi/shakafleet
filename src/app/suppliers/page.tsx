  ...
  return (
    <div className="min-h-screen">
      <header className="sticky top-0 z-10 border-b border-white/10 bg-slate-950/70 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4">
          ...
          <nav className="hidden items-center gap-6 text-sm text-slate-300 md:flex">
            ...
            <Link className="text-white font-medium" href="/suppliers">Fournisseurs</Link>
            <Link className="hover:text-white" href="/sales">Ventes</Link>
      ...
      <main className="mx-auto max-w-7xl px-4 py-8">
        <SuppliersClient isAdmin={isAdmin} />
      </main>
    </div>
  );
}
